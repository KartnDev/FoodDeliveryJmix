...
@Service
public class CookingRestaurantStep extends AbstractTransactionalStep {
    protected CookingRestaurantStep(SystemAuthenticator systemAuthenticator,
    ...
    protected void doTransactionalStep(DelegateExecution execution, OrderEntity order, SaveContext saveContext) {
        order.setStatus(DraftOrderStatus.RESTAURANT_COOKING);
