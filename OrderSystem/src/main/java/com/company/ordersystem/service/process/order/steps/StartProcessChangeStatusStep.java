...
@Service
public class StartProcessChangeStatusStep extends AbstractTransactionalStep {
    protected StartProcessChangeStatusStep(SystemAuthenticator systemAuthenticator,
