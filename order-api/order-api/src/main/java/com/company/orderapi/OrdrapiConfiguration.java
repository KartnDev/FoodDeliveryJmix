...
@PropertySource(name = "com.company.orderapi", value = "classpath:/com/company/orderapi/module.properties")
public class OrdrapiConfiguration {

    @Bean("ordrapi_OrdrapiViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.orderapi"));
        return viewControllers;
    }

    @Bean("ordrapi_OrdrapiActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.orderapi"));
        return actions;
    }
}
